...
namespace ProdigyPlanningAPI.Migrations
{
    ...
    [Migration("20240522133523_Securityquestion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProdigyPlanningAPI.Models.SecurityQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProdigyPlanningAPI.Models.UserQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProdigyPlanningAPI.Models.UserQuestion", b =>
                {
                    b.HasOne("ProdigyPlanningAPI.Models.SecurityQuestion", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProdigyPlanningAPI.Models.User", "User")
                        .WithOne("UserQuestion")
                        .HasForeignKey("ProdigyPlanningAPI.Models.UserQuestion", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
